...
export default function Login() {
  ...
  const [lastOtp, setLastOtp] = useState(''); // store OTP for dev mode display
  ...
  const sendOtp = async () => {
    ...
    try {
      ...
      if (data.devMode && data.otp) {
        setLastOtp(data.otp);
        toast(`📧 Dev Mode OTP: ${data.otp} (copied to input below)`, 'i');
    ...
    <div className="auth-layout page-enter">
      <div className="auth-left">
        ...
        <div className="auth-left-content">
          ...
          <p className="auth-left-sub">Log in with your registered email. OTP shown in toast in dev mode.</p>
